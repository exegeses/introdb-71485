...
--
-- Host: 127.0.0.1    Database: introdb71485
-- ------------------------------------------------------
...
CREATE TABLE `monedas` (
  ...
  `exacto` decimal(9,2) unsigned zerofill NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `monedas` VALUES (1,12.5,0000012.50),(2,26.84,0000026.84),(3,38.4,0000038.40),(4,6,0000006.00),(5,50.32,0000050.32),(6,28,0000028.00);
...
INSERT INTO `personas` VALUES (1,'García','Javier',25852410,'2008-12-12'),(2,'González','Mónica',36520147,'2009-09-30'),(3,'Martínez','Vanesa',35741951,'2006-12-12'),(4,'Álvarez','Fernando',32912457,'2007-11-02'),(5,'Page','Jimmy',18543219,'1954-01-09'),(6,'Plant','Robert',18543220,'1960-01-09'),(7,'Bonham','Bonzo',18543221,'1960-01-09'),(8,'Jones','John',18543222,'1960-01-09');
...
-- Dump completed on 2024-06-19 16:16:28
